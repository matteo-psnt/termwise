...
func toMessageParams(msgs []ai.Message) ([]sdk.MessageParam, error) {
...
func toMessageParam(m ai.Message) (sdk.MessageParam, error) {
	switch m.Role {
	case "user":
...
func toUserMessageParam(m ai.Message) (sdk.MessageParam, error) {
...
func toAssistantMessageParam(m ai.Message) (sdk.MessageParam, error) {
	var blocks []sdk.ContentBlockParamUnion
...
func toToolParams(tools []ai.ToolDef) []sdk.ToolUnionParam {
...
func fromResponse(msg *sdk.Message) *ai.CompleteResponse {
...
func fromChatResponse(msg *sdk.Message) (*ai.ChatResponse, error) {
